...
> Genesis Columns Advanced was originally designed for the Classic Editor and does not integrate that well with the new Gutenberg/Block Editor. While this plugin still functions properly in the current versions of WordPress, we encourage users to begin adopting the columns block in the Block Editor instead of using this plugin. While no new development will be done to integrate this plugin with the new functionality of WordPress, support will still be provided.
