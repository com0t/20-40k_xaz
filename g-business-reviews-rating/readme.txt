...
Totally restriction-free Google reviews and rating as Shortcode/Widget. Extensive display options; lots of delicious themes; includes Structured Data.
...
*This is my first public plugin, so [all comments](https://designextreme.com/wordpress/) are very welcome. I would also like to see your usage so I can introduce new themes. There is a sister plugin: [We’re Open!](https://wordpress.org/plugins/opening-hours/) which retrieves current opening hours from Google My Business.*
...
3. Use the **Settings**→**Reviews and Rating – Google My Business** screen to configure the plugin with your [Google API Key](https://console.developers.google.com/apis/credentials) and the business’ [Place ID](https://developers.google.com/places/place-id). Here is a copy of the same instructions:
	a. Create a new project or open an existing project in [Google Developer&rsquo;s Console](https://console.developers.google.com/apis/credentials);
	b. Check the API: [Places API](https://console.cloud.google.com/apis/library/places-backend.googleapis.com?q=place) is enabled in your account;
	c. In the Console, go to: [Credentials](https://console.developers.google.com/apis/credentials);
	d. Click “+ Create Credentials”;
	e. Select “API Key”;
	f. Click “Restrict Key”;
	g. Set “Application restrictions” to “IP addresses” and enter your IP;
	h. Under the heading: “API restrictions”, select “Restrict Key” and select: “Places API”;
	i. Click “Save”;
	j. Finally for regular requests, please [enable billing](https://console.cloud.google.com/project/_/billing/enable) for your project to receive your *substantial and free* API request allocation.
...
= Can I limit my API requests to keep it within my free allowance? =
...
Yes, you can edit the respective options for each to: *compress* to load the minified version of the JavaScript file and the style sheet file.
...
* Added Shortcode instance counter
...
* Updated Structured Data output to support author field (Thanks to @geroroe)
...
* Fixed overall review count singular/plural word in some instances (Thanks to @hitec4ever)
