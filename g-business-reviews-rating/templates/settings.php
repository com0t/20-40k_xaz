            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        ...
                        <?php /* translators: 1: a HTML ID, 2: URL of Google Developer Console, 3: URL of Place API, 4: URL of Google Developer Console, 5: IP of web server, 6: URL for Google billing account */
						echo sprintf(__('<ol id="%1$s">
							<li>Create a new project or open an existing project in <a href="%2$s" class="components-external-link" target="_blank">Google Developer’s Console</a>;</li>
							<li>Check the API: <a href="%3$s" class="components-external-link" target="_blank">Places API</a> is enabled in your account;</li>
							<li>In the Console, go to: <a href="%4$s" class="components-external-link" target="_blank">Credentials</a>;</li>
							<li>Click “+ Create Credentials”;</li>
							<li>Select “API Key”;</li>
							<li>Click “Restrict Key”;</li>
							<li>Set “Application restrictions” to “IP addresses” and enter: <span class="highlight">%5$s</span> ;</li>
							<li>Under the heading: “API restrictions”, select “Restrict Key” and select: “Places API”;</li>
							<li>Click “Save”;</li>
							<li>Finally for regular requests, please <a href="%6$s" class="components-external-link" target="_blank">enable billing</a> for your project to receive your <em>substantial and free</em> API request allocation.</li>
						</ol>', 'g-business-reviews-rating'), 'welcome-google-credentials-steps', 'https://console.developers.google.com/apis/credentials', 'https://console.cloud.google.com/apis/library/places-backend.googleapis.com?q=place', 'https://console.developers.google.com/apis/credentials', $this->server_ip(), 'https://console.cloud.google.com/project/_/billing/enable'); ?>
                    </td>
                </tr>
                <tr>
...
?>
                        ...
                        <label for="stylesheet"><input type="checkbox" id="stylesheet" name="google_business_reviews_rating_stylesheet" value="<?php echo (get_option('google_business_reviews_rating_stylesheet') ? get_option('google_business_reviews_rating_stylesheet', 1) : '1'); ?>"<?php echo (get_option('google_business_reviews_rating_stylesheet') ? ' checked="checked"' : ''); ?>> <?php esc_html_e('Load Style Sheet', 'g-business-reviews-rating'); ?></label>
                ...
                <tr>
                    ...
                    <td>
						...
						echo sprintf(__('<ol id="%1$s">
							...
							<li>Click “Save”;</li>
							<li>Finally for regular requests, please <a href="%6$s" class="components-external-link" target="_blank">enable billing</a> for your project to receive your <em>substantial and free</em> API request allocation.</li>
						</ol>', 'g-business-reviews-rating'), 'google-credentials-steps', 'https://console.developers.google.com/apis/credentials', 'https://console.cloud.google.com/apis/library/places-backend.googleapis.com?q=place', 'https://console.developers.google.com/apis/credentials', $this->server_ip(), 'https://console.cloud.google.com/project/_/billing/enable'); ?>
                    </td>
                </tr>
                <tr>
    ...
    <div id="shortcodes" class="section<?php echo ($this->section != 'shortcodes') ? ' hide' : ''; ?>">
      <form method="post" action="options.php" id="google-business-reviews-rating-shortcodes">
            ...
            <p><?php /* translators: %s: URL for Shortcode Demonstration Website */
				echo sprintf(__('Here is a selection of Shortcodes with some of the parameters available. You can find more examples in the <a href="%s" class="components-external-link" target="_blank">demonstration website</a>.', 'g-business-reviews-rating'), 'https://demo.designextreme.com/reviews-rating-google-business/'); ?></p>
			<div class="columns">
                <div class="left">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                            	<input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode abbreviated" type="text" value="[reviews_rating theme=&quot;dark&quot; min=3 max=5 offset=0 limit=3 summary=&quot;yes&quot; icon=&quot;no&quot; excerpt=160 more=&quot;read more&quot;]" readonly>
                            	<input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode additional" type="text" value="[reviews_rating language=&quot;nl&quot; review_word=&quot;recensie/recensies&quot;]" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            	<input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode abbreviated" type="text" value="[reviews_rating theme=&quot;columns three fonts&quot; vicinity=&quot;E4, London&quot; reviews_link=&quot;View Google Reviews&quot; write_review_link=&quot;Leave A Review&quot;]" readonly>
                            	<input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode additional" type="text" value="[reviews_rating theme=&quot;dark&quot; min=3 max=5 offset=0 limit=3]" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            	<input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode abbreviated" type="text" value="[reviews_rating icon=&quot;/wp-content/uploads/logo.png&quot; avatar=&quot;false&quot; review_item_order=&quot;text first&quot; review_text_min=200]" readonly>
                            	<input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode additional" type="text" value="[reviews_rating summary=&quot;yes&quot; icon=&quot;no&quot; excerpt=160 more=&quot;read more&quot;]" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            	<input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode abbreviated" type="text" value="[reviews_rating place_id=&quot;ChIJtTeDfh9w5kcRJEWRKN1Yy6I&quot; animate=&quot;no&quot; review_text=&quot;no&quot; attribution=&quot;yes&quot;]" readonly>
                            	<input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode additional" type="text" value="[reviews_rating theme=&quot;columns three fonts&quot; reviews_link=&quot;View Google Reviews&quot; write_review_link=&quot;Leave A Review&quot;]" readonly>
                            </td>
                        </tr>
                        <tr class="additional">
                            <td><input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode" type="text" value="[reviews_rating avatar=&quot;false&quot; review_item_order=&quot;text first&quot; review_text_min=200]" readonly></td>
                        </tr>
                        <tr class="additional">
                            <td><input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode" type="text" value="[reviews_rating icon=&quot;/wp-content/uploads/logo.png&quot; name=&quot;Star Consultancy&quot; vicinity=&quot;E4, London&quot;]" readonly></td>
                        </tr>
                        <tr class="additional">
                            <td><input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode" type="text" value="[reviews_rating place_id=&quot;ChIJaxhvijEFdkgRPtwPZgzI4w8&quot; animate=&quot;no&quot; review_text=&quot;no&quot;]" readonly></td>
                        </tr>
                        <tr class="additional">
                            <td><input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode" type="text" value="[reviews_rating summary=false date=false limit=3 min=5 review_text_min=140 review_text_max=290 name_format=&quot;last initial&quot;]" readonly></td>
                        </tr>
                        <tr class="additional">
                            <td><input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode" type="text" value="[reviews_rating theme=&quot;bubble center fill columns three&quot; summary=false limit=3 min=5 excerpt=150]" readonly></td>
                        </tr>
                        <tr class="additional">
                            <td><input id="<?php echo 'shortcode-' . $id; $id++; ?>" name="shortcode[]" class="shortcode" type="text" value="[reviews_rating theme=&quot;narrow center&quot; summary=&quot;icon, name, rating, stars, count&quot; limit=0 stars=&quot;css&quot;]" readonly></td>
                        </tr>
                    </table>
                </div>
                <div class="right">
            ...
            <table class="wp-list-table widefat fixed striped parameters">
                ...
                <tr id="parameter-id">
                    ...
                    <td class="description"><?php /* translators: %s: bookmark for reviews */
						echo sprintf(__('Specify reviews by ID (see <a href="%s">Reviews</a>); ordering is preserved within a list; comma separated for two or more IDs.', 'g-business-reviews-rating'), '#reviews'); ?></td>
                ...
                <tr id="parameter-date">
                    ...
                    <td class="description"><?php /* translators: use local language version at php.net if available */ _e('Choose how to display the review dates, either using the <a href="https://www.php.net/date" class="components-external-link" target="_blank">PHP date</a>, relative text or to hide entirely. Actual review date may be an approximation if imported.', 'g-business-reviews-rating'); ?></td>
                ...
                <tr id="parameter-link-disable">
                    ...
                    <td class="description"><?php /* translators: 1: parameter value for switching author name in review listings, 2: parameter value for setting author details to appear inline in the review listings */
						echo sprintf(__('Disable all links or disable specific links based on their purpose: <em>%1$s</em>, <em>%2$s</em> or <em>%3$s</em>; use a comma separated list for multiple selections.', 'g-business-reviews-rating'), 'reviews', 'write review', 'author'); ?></td>
                ...
                <tr id="parameter-review-item-order">
                    ...
                    <td class="description"><?php /* translators: 1: parameter value for switching author name in review listings, 2: parameter value for setting author details to appear inline in the review listings */
						echo sprintf(__('Change the ordering of each review item &mdash; review text can be set to appear at the top of each entry. Add <em>%1$s</em> to switch the author&rsquo;s avatar and name with stars and date. Add <em>%2$s</em> to set the author name, stars and date inline. This may be extended if there is a <a href="https://designextreme.com/wordpress/" class="components-external-link" target="_blank">demand</a>.', 'g-business-reviews-rating'), 'author switch', 'inline'); ?></td>
                    <td class="accepted"><span class="code">NULL</span>, &quot;text first&quot;, &quot;text last&quot;, &quot;author switch&quot;, inline, &quot;text first inline&quot;, &quot;author switch inline&quot;, &quot;text first author switch inline&quot;</td>
            ...
            <table class="wp-list-table widefat fixed striped classes">
              ...
              <tr id="class-light">
                ...
                <tr>
                  ...
                  <td class="description"><?php _e('Organize reviews in columns of two, three or four. Works with two, three or four added.', 'g-business-reviews-rating'); ?></td>
                  <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                  <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="class">stars-yellow</td>
                  <td class="description"><?php _e('Set the star color to the current hue as used by Google.', 'g-business-reviews-rating'); ?></td>
                  <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                  <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr>
                  <td class="class">stars-orange</td>
                  <td class="description"><?php _e('Set the star color to orange, as currently used within this plugin. Set if you intend to intentionally keep this color in future versions.', 'g-business-reviews-rating'); ?></td>
                  <td class="boolean"><span class="dashicons dashicons-yes"></span></td>
                  <td class="boolean"><span class="dashicons dashicons-no"></span></td>
                </tr>
                <tr>
...
<?php endif; ?>
        <form method="post" action="options.php" id="google-business-reviews-rating-settings-custom-styles">
            ...
            <p class="submit">
                <button type="button" name="save" id="custom-styles-button" class="button button-primary"><?php esc_html_e('Save', 'g-business-reviews-rating'); ?></button>
            </p>
        </form>
<?php if (!$this->demo): ?>
